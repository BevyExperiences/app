...
export const listingFields = [
  {
    ...
    enumOptions: [
      { option: 'art-culture', label: 'Art & Culture' },
      { option: 'beach-boating', label: 'Beach & Boating' },
      { option: 'food-drink', label: 'Food & Drink' },
      { option: 'relax-meditation', label: 'Relax & Meditation' },
      { option: 'fun-sports', label: 'Fun & Sports' },
      { option: 'sightseeing', label: 'Sightseeing' },
      { option: 'team-building', label: 'Team-Building' },
    ],
    filterConfig: {
      indexForSearch: true,
      label: 'subcategory',
