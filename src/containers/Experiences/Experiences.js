                ...
                <div className={css.sectionfiltercontet}>
                  <div className={css.desktopfilter}>
                    <div className={css.sectionfilter}>
                      ...
                      >
                        <FontAwesomeIcon icon={faPerson} color="#06c167" />
                        In-person
                      </div>
                      <div
                        className={
                      ...
                      >
                        <FontAwesomeIcon icon={faPeopleGroup} color="#06C167" />
                        Venues
                      </div>
                      <div
                        className={
                      ...
                      >
                        <FontAwesomeIcon icon={faBrain} color="#06C167" />
                        Retreats
                      </div>
                      <div
                        className={
                      ...
                      >
                        <FontAwesomeIcon icon={faLaptop} color="#06C167" />
                        Virtual
                      </div>
                    </div>
                    <div className={css.sectionfilterbtn} onClick={() => onClickFilterBtn()}>
                      <FontAwesomeIcon icon={faSliders} color="#06C167" />
                      Filter
                    </div>
                  </div>
